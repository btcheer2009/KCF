...
export default function App() {
  ...
  const [assocPermitNumber, setAssocPermitNumber] = useState('');
  const [assocBusinessNumber, setAssocBusinessNumber] = useState('');
  const [assocRepresentative, setAssocRepresentative] = useState('');
  ...
  const handleDeleteEventFromAdmin = (id: string) => {
    showConfirm(
      ...
      () => {
        ...
        setEvents(updated);
        localStorage.setItem('kcf_events', JSON.stringify(updated));
      }
    );
  };
  ...
  const handleUpdateImage = (key: keyof typeof DEFAULT_IMAGES, url: string) => {
    ...
    localStorage.setItem('kcf_site_images', JSON.stringify(updated));
  };

  const handleUpdateAssociationInfo = (updatedInfo: AssociationInfo) => {
    setAssociationInfo(updatedInfo);
    localStorage.setItem('kcf_association_info', JSON.stringify(updatedInfo));
  };
  ...
  const handleUpdatePassword = (newPass: string) => {
    ...
    localStorage.setItem('kcf_admin_password', newPass);
  };
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-950 font-sans antialiased selection:bg-blue-500/10 selection:text-blue-900">
      ...
      <nav className="w-full fixed top-0 left-0 z-50 h-16 bg-white/95 backdrop-blur-md border-b border-zinc-200/80 shadow-xs px-4 sm:px-6 lg:px-16 flex justify-between items-center transition-all duration-300">
        ...
        <div className="hidden md:flex items-center gap-1 lg:gap-2 text-xs lg:text-sm font-semibold text-zinc-500">
          <button
          ...
          {currentTab === 'home' && (
            ...
            >
              ...
              <header id="hero" className="relative min-h-screen pt-36 md:pt-28 flex flex-col justify-between px-6 lg:px-16 pb-12 overflow-hidden bg-zinc-50/35">
                ...
                <div className="relative z-10 mt-14 max-w-4xl">
                  <motion.div
                    ...
                    className="space-y-6"
                  >
                    <h1 className="text-4xl md:text-6xl lg:text-7.5xl font-serif font-black leading-[1.08] tracking-tighter text-zinc-950 uppercase">
                      열정으로 비상하는 <br />
            ...
            >
              ...
              <section id="services" className="py-24 px-6 lg:px-16 bg-white relative">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 flex flex-col items-center">
                  ...
                  <h3 className="text-3xl md:text-5xl font-serif text-zinc-950 font-black tracking-tight uppercase leading-none">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-[11px] leading-relaxed text-slate-400 max-w-xs">
              사단법인 한국치어리딩협회 (Korea Cheerleading Federation)는 대한민국 치어리딩 종목을 총괄하며 안전 중심 교육, 공정한 대표 선발을 리드합니다.
            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {[
                        ...
                        <div key={imgConfig.key} className="bg-zinc-50 border border-zinc-200 p-4 rounded-2xl flex flex-col justify-between gap-4">
                          ...
                          <div className={`rounded-xl overflow-hidden bg-zinc-200 border border-zinc-200 relative ${imgConfig.aspect}`}>
                            <img
                              ...
                              <div className="space-y-1">
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    localStorage.setItem('kcf_category_headers', JSON.stringify(updated));
                                  }}
                              ...
                              <div className="space-y-1">
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    localStorage.setItem('kcf_core_promises', JSON.stringify(updated));
                                  }}
